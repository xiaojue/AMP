...
<style scoped>
.page-list {font-size: 0;color: #333;text-align: right;-webkit-text-size-adjust: none;-webkit-user-select: none;line-height: 22px;margin-top: 11px;margin-right: 10px;}
